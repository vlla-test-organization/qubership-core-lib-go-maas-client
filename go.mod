module github.com/vlla-test-organization/qubership-core-lib-go-maas-client/v3
...
require (
	...
	github.com/vlla-test-organization/qubership-core-lib-go-stomp-websocket/v3 v3.0.6
